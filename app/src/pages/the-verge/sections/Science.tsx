        ...
        <div className="p-6 bg-verge-black">
            <div className="grid grid-cols-12  p-3 bg-verge-black">
                ...
                <div className="col-span-12 sm:col-spa-10 md:col-span-6 lg:col-span-8 grid grid-cols-2 relative">
                    ...
                    <div className="section-side col-span-2 lg:col-span-1 bg-verge-orange m-6 p-3 rounded-2xl lg:sticky lg:top-0 h-fit">
                        <h1 className="font-verge-oswald font-extrabold text-black -rotate-90 bottom-0 -translate-y-6 translate-x-40 text-4xl scale-y-[1.7] opacity-30">Science</h1>
                        <h1 className="hidden font-verge-oswald font-extrabold text-black -rotate-90 bottom-0 -translate-y-6 translate-x-40 text-4xl scale-y-[1.7] opacity-30">Science</h1>
                        <p className="text-xs text-white font-mpd-jost">SCIENCE</p>
