        ...
        <div className="p-6 bg-verge-black">
            <div className="grid grid-cols-12 p-3 bg-verge-black">
                ...
                <div className="col-span-12 sm:col-spa-10 md:col-span-6 lg:col-span-8 grid grid-cols-2 relative">
                    ...
                    <div className="section-side col-span-2 lg:col-span-1 bg-verge-pink m-6 p-3 rounded-2xl lg:sticky lg:top-0 h-fit">
                        <h1 className="font-verge-oswald font-extrabold text-black -rotate-90 bottom-0 -translate-y-6 translate-x-40 text-4xl scale-y-[1.7] opacity-30">Entertainment</h1>
                        <h1 className="hidden font-verge-oswald font-extrabold text-black -rotate-90 bottom-0 -translate-y-6 translate-x-40 text-4xl scale-y-[1.7] opacity-30">Entertainment</h1>
                        <p className="text-xs text-black font-mpd-jost">ENTERTAINMENT</p>
                        <div className="grid grid-cols-12 pb-3  m-3 ">
                            <div className="col-span-1">
                            </div>
                            <div className="col-span-11 border-l border-l-white pl-4 ml-2">
                                <h1 className="text-2xl text-black font-verge-oswald font-semibold hover:text-white"> Wear OS watches might soon have an edge when it comes to blood oxygen</h1>
                                <p className="text-black font-mpd-jost uppercase text-sm">Victoria Song Sep 21 | 22</p>
                            </div>
                        </div>
                        <img src={openai} alt="Wear OS" className="w-3/4 p-1 h-auto" />
                        <div className="grid grid-cols-12 pb-3  m-3">
                            <div className="col-span-1">
                                <p className=" text-white font-mpd-jost w-fit h-fit p-2 text-3xl">&bull;</p>
                            </div>
                            <div className="col-span-11 pb-2 border-b border-b-verge-aqua">
                                <h1 className="font-semibold text-black font-mpd-jost hover:text-white">
                                Cards Against Humanity is suing SpaceX for trespassing on its ‘pristine’ property
                                     </h1>
                                <p className="text-black font-mpd-jost uppercase text-sm">Gaby Del Valle Sep 21 | 94</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-12 pb-3  m-3">
                            <div className="col-span-1">
                            ...
                            <div className="col-span-11">
                                <h1 className="font-semibold text-black font-mpd-jost hover:text-white "> Microsoft wants Three Mile Island to fuel its AI power needs</h1>
                                <p className="text-black font-mpd-jost uppercase text-sm"> Tom Warren Sep 20 | 71</p>
                            </div>
                        </div>
