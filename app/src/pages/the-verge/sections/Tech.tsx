            ...
            <div className="grid grid-cols-12 p-3 bg-verge-black">
                ...
                <div className="col-span-12 sm:col-spa-10 md:col-span-6 lg:col-span-8 grid grid-cols-2 relative">
                    ...
                    <div className="section-side col-span-2 lg:col-span-1 bg-verge-pink m-6 p-3 rounded-2xl lg:sticky lg:top-0 h-fit">
                        <h1 className="font-verge-oswald font-extrabold text-black -rotate-90 bottom-0 -translate-y-6 translate-x-40 text-4xl scale-y-[1.7] opacity-30">Tech</h1>
                        <h1 className="hidden font-verge-oswald font-extrabold text-black -rotate-90 bottom-0 -translate-y-6 translate-x-40 text-4xl scale-y-[1.7] opacity-30">Tech</h1>
                        <p className="text-xs text-black font-mpd-jost">TECH</p>

                        <div className="grid grid-cols-12 pb-3  m-3 ">
                            <div className="col-span-1">
                            </div>
                            <div className="col-span-11 border-l border-l-white pl-4 ml-2">
                                <h1 className="text-2xl text-black font-verge-oswald font-semibold hover:text-white"> Jony Ive confirms he’s working on a new device with OpenAI</h1>
                                <p className="text-black font-mpd-jost uppercase text-sm">Alex Cranz Sep 22 |  35</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-12 pb-3  m-3">
                            ...
                            <div className="col-span-11 pb-2 border-b border-b-verge-aqua">
                                ...
                                <p className="text-black font-mpd-jost uppercase text-sm">Richard Lawler Sep 23 | 9</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-12 pb-3  m-3">
                            <div className="col-span-1">
                            ...
                            <div className="col-span-11">
                                ...
                                <p className="text-black font-mpd-jost uppercase text-sm">Andrew Liszewski Sep 21 | 4</p>
                            </div>
                        </div>
