        ...
        <div className="p-6 bg-verge-black">
            <div className="grid grid-cols-12">
                ...
                <div className="col-span-12 sm:col-spa-10 md:col-span-6 lg:col-span-8 grid grid-cols-2 relative">
                    ...
                    <div className="section-side col-span-2 lg:col-span-1 bg-verge-yellow m-6 p-3 rounded-2xl lg:sticky lg:top-0 h-fit">
                        <h1 className="font-verge-oswald font-extrabold text-black -rotate-90 bottom-0 -translate-y-6 translate-x-40 text-4xl scale-y-[1.7] opacity-30">Podcasts</h1>
                        <h1 className="hidden font-verge-oswald font-extrabold text-black -rotate-90 bottom-0 -translate-y-6 translate-x-40 text-4xl scale-y-[1.7] opacity-30">Podcasts</h1>
                        <p className="text-xs text-black font-mpd-jost">PODCASTS</p>
                        <div className="grid grid-cols-12 pb-3 border-b-2 border-b-verge-aqua m-3 ">
                            <div className="col-span-1">
                                <p className="rounded-full bg-black text-verge-aqua font-mpd-jost  w-fit h-fit p-2">&#9654;</p>
                            </div>
                            <div className="col-span-11">
                                <h1 className="text-2xl text-black font-mpd-jost"> OceanGate’s ill-fated Titan sub relied on a hand-typed Excel spreadsheet</h1>
                                <p className="text-black font-mpd-jost uppercase text-sm"> Andrew Liszewski Sep 20 | 14</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-12 pb-3 border-b-2 border-b-verge-aqua m-3">
                            <div className="col-span-1">
                            ...
                            <div className="col-span-11">
                                <h1 className="text-2xl text-black font-mpd-jost"> Watch the iPhone 16’s electrically-charged battery replacement process</h1>
                                <p className="text-black font-mpd-jost uppercase text-sm"> Richard Lawler Sep 22 | 7</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-12 pb-3 border-b-2 border-b-verge-aqua  m-3">
                            <div className="col-span-1">
                            ...
                            <div className="col-span-11">
                                <h1 className="text-2xl text-black font-mpd-jost">The buttons on Zenith’s original ‘clicker’ remote were a mechanical marvel</h1>
                                <p className="text-black font-mpd-jost uppercase text-sm"> Andrew Marino Jul 29 | 65</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-12 pb-3 border-b-2 border-b-verge-aqua m-3">
                            <div className="col-span-1">
                            ...
                            <div className="col-span-11">
                                <h1 className="text-2xl text-black font-mpd-jost"> WhatsApp will send messages to other apps soon — here’s how it will look</h1>
                                <p className="text-black font-mpd-jost uppercase text-sm"> Emma Roth Sep 6 | 52</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-12 pb-3 border-b-verge-aqua border-b-2 m-3">
                            ...
                            <div className="col-span-11">
                                <h1 className="text-2xl text-black font-mpd-jost">Meta has a major opportunity to win the AI hardware race
                                </h1>
                                <p className="text-black font-mpd-jost uppercase text-sm"> Victoria Song Sep 21 | 74</p>
                            </div>
                        </div>
